...
export const metadata: Metadata = {
  title: "AdhritVerse | Cyber & Web Innovation Consultancy",
  description: "Delivering secure, scalable, and high-performance digital solutions for startups and enterprises.",
  icons: {
    icon: "/logo.png",
  },
};
