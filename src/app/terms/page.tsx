  ...
  return (
    <main className="min-h-screen relative" style={{ background: "var(--bg-base)" }}>
      ...
      <section className="pt-32 sm:pt-40 pb-10 text-center px-6 relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100 border border-[var(--border)] mb-4 text-[10px] sm:text-xs text-[var(--text-secondary)] tracking-widest uppercase">
          <i className="fas fa-file-contract text-primary" />
          Legal Document
        </div>
        <h1 className="font-display text-[26px] sm:text-5xl md:text-6xl font-bold text-[var(--text-primary)] mb-4 leading-tight">
          Terms of <span className="text-gradient">Service</span>
        </h1>
        <p className="text-xs sm:text-base text-[var(--text-secondary)] max-w-xl mx-auto leading-relaxed">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 pb-20 md:pb-28">
        <div className="prose prose-slate max-w-none text-[var(--text-secondary)]">
          <div className="glass-card p-8 sm:p-12 rounded-3xl border border-[var(--border)]">
            ...
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">2. Services Rendered</h2>
            <p className="mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">4. Payment Terms</h2>
            <p className="mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">5. Confidentiality</h2>
            <p className="mb-6 leading-relaxed">
            ...
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">7. Governing Law</h2>
            <p className="mb-6 leading-relaxed">
